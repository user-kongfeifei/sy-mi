...
import { Button, Grid, GridItem,Tabbar, TabbarItem,Swipe, SwipeItem ,NavBar,Icon,Sticky,Sku,Cell,CellGroup,Col, Row ,Search,
  Tab, Tabs,Sidebar, SidebarItem  } from 'vant'
...
.use(Sticky).use(Sku).use(Tab).use(Tabs).use(Cell).use(CellGroup).use(Col).use(Row).use(Search).use(Sidebar).use(SidebarItem);
